...
public:
    ...
    void setupUi(QDialog *AboutDialog)
    {
        ...
        copyrightLabel->setText(QLatin1String("Copyright &copy; 2015-YYYY The Bitcoin developers\n"
"Copyright &copy; 2015-YYYY The Bitgoldcoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Bitgoldcoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Bitgoldcoin</b> version", 0));
